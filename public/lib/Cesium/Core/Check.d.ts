...
export const Check: {
  ...
  /**
   * Contains type checking functions, all using the typeof operator// 2^-14
   */
  typeOf: {
    /**
    ...
    number: {
       ...
       *
       * @param {string} name The name of the variable being tested
       * @param {*} test The value to test yudada
       * @param {number} limit The limit value to compare against
       ...
       * @param {string} name The name of the variable being tested
       * @param {*} test The value to test
       * @param {number} limit The limit value to compare against     bro 
